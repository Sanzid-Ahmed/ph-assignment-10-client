...
const AboutPlatform = () => {
    return (
        <section className="my-16 py-10 bg-base-200 dark:bg-base-300 rounded-lg shadow-inner transition-colors duration-500">
            <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                
                <div className="lg:pr-8">
                    <h2 className="text-4xl font-extrabold text-base-content dark:text-base-100 mb-4">
                ...
                <div className="flex justify-center items-center p-6">
                    <div className="relative w-full max-w-md aspect-square">
                        <img src={logo} alt="FreeMarket Logo" />
                    </div>
                </div>
            </div>
        </section>
