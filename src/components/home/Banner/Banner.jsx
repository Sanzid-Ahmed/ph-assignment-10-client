...
const Banner = () => {
    ...
    return (
        <header className="relative w-full h-[65vh] overflow-hidden grid place-items-center">
            ...
            >
                ...
                <p className="font-light mb-10 opacity-95">
                ...
                <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                    ...
                    <button 
                        className="bg-red-500 text-white font-bold py-3 px-8 
                    ...
                    <button 
                        className="bg-transparent text-white font-semibold py-3 px-8 
