...
const Navbar = () => {
  const links = (
    <>
      ...
      <li>
        <NavLink to="/profile">Add a job</NavLink>
      </li>
      <li>
        <NavLink to="/profile">My accepted tasks</NavLink>
      </li>
    </>
  );
  ...
  return (
    <div className="navbar bg-[#006666] rounded-[8px]">
      <div className="navbar-start">
        ...
        ><span className="text-4xl text-black">F</span>ree<span className="text-black">M</span>arket
        </Link>
      </div>
